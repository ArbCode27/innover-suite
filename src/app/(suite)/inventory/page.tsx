...
import { loadInventoryCatalog, loadDeliveryZones, loadInventoryMovements, loadPromotions } from "@/lib/commerce/catalog";
...
export default async function InventoryPage() {
  ...
  try {
    [products, promotions, movements, zones] = await Promise.all([
      loadInventoryCatalog(supabase, membership.organizationId),
